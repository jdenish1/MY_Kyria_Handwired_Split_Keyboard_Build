 ...
 *                        `----------------------------------'  `----------------------------------'
 */
    [QWER] = LAYOUT_split_3x6_5(
      KC_TAB  , KC_Q ,  KC_W   ,  KC_E  ,   KC_R ,  KC_T  ,                                        KC_Y   , KC_U   , KC_I   , KC_O  , KC_P   , KC_BSPC ,
      CTL_ESC , KC_A ,  KC_S   ,  KC_D  ,   KC_F ,  KC_G  ,                                        KC_H   , KC_J   , KC_K   , KC_L  , KC_SCLN, CTL_QUOT,
      KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,  KC_B  , KC_LBRC, KC_CAPS,       NUM , KC_RBRC, KC_N   , KC_M   , KC_COMM, KC_DOT, KC_SLSH, KC_RSFT ,
 ...
 */
    [NUM] = LAYOUT_split_3x6_5(
      ...
      KC_PIPE, KC_BSLS, KC_COLN, KC_SCLN, KC_MINS, KC_LBRC, KC_LCBR,  QWER,    KC_TRNS, KC_RCBR, KC_RBRC, KC_UNDS, KC_COMM, KC_DOT , KC_SLSH, KC_QUES,
                                 KC_APP , KC_LGUI, ALT_ENT, KC_SPC ,  NAV ,     FKEY  , KC_SPC , KC_RALT, KC_RGUI, KC_MUTE
    ),
 ...
 * `-------------------------+-------+-------+-------+------+------|  |------+------+------+------+------+----------------------'
 *                           | Adjust| LGUI  | LAlt/ | Space|      |  | FKEYS| Space| AltGr| RGUI | Mute |
 *                           | (Enco)|       | Enter |      |      |  |      |      |      |      |(Enco)|
 *                           `-------------------------------------'  `----------------------------------'
 */
    [NAV] = LAYOUT_split_3x6_5(
      ...
      KC_TRNS, RGB_SPD, RGB_RMOD, RGB_VAD, RGB_HUD, RGB_SAD, KC_TRNS,  QWER  ,    NUM, KC_TRNS, KC_PAUS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_PSCR,
                                  KC_APP , KC_LGUI, ALT_ENT, KC_SPC , KC_TRNS,   FKEY, KC_SPC , KC_RALT, KC_RGUI, KC_MUTE
    ),
 ...
 */
    [FKEY] = LAYOUT_split_3x6_5(
      ...
      KC_TRNS, KC_F1, KC_F2 ,  KC_F3 , KC_F4 , KC_TRNS,  KC_TRNS,  QWER,     NUM  , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                               KC_APP,KC_LGUI, ALT_ENT,  KC_SPC ,  NAV ,   KC_TRNS, KC_SPC , KC_RALT, KC_RGUI, KC_MUTE
    ),
